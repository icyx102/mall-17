...
public class ShopCartServiceImpl implements ShopCartService {
    ...
    public void addCart(int productId, HttpServletRequest request) throws Exception {
        ...
        List<Integer> productIds = (List<Integer>) request.getSession().getAttribute(NAME_PREFIX + loginUsers.getId());
        if (productIds == null) {
            productIds = new ArrayList<>();
            request.getSession().setAttribute(NAME_PREFIX + loginUsers.getId(), productIds);
        }
